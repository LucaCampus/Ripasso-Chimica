...
while True:
    while quiz:
            file_domande = open("elementi_tot.txt", "r")
            file_risposte = open("risposte_tot.txt", "r")
            ...
            print(f"Inserisci simbolo, stato di aggregazione, numero di ossidazione e gruppo di {domanda}") 
    ...
    while add:
        file_domande = open("elementi.txt", "a")
        file_risposte = open("risposte.txt", "a")
        QW = True
        AW = True
        while QW:
            domanda = (input("Inserisci nuovo elemento: "))
            check3 = input("Sei sicuro di volerlo aggiungere?Y/n\n")
            if check3 == "Y" or check3 == 'y':
                file_domande.write(domanda + '\n')
                QW = not QW

        while AW:
            risposta=(input("Inserisci simbolo, stato di aggregazione, numero di ossidazione e gruppo di dell'elemento:  "))
